...
objump: cargo
	objdump -S --disassembler-options=intel-nmemonic -d target/x86_64-unknown-intermezzos-gnu/release/intermezzos | less

objump-debug: cargo-debug
	objdump -S --disassembler-options=intel-nmemonic -d target/x86_64-unknown-intermezzos-gnu/debug/intermezzos | less
